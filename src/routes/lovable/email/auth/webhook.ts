...
// Configuration
const SITE_NAME = "h2go-beta"
const SENDER_DOMAIN = "notify.h2go-app.com"
const ROOT_DOMAIN = "h2go-app.com"
const FROM_DOMAIN = "h2go-app.com"
      ...
      POST: async ({ request }) => {
        ...
        const { error: enqueueError } = await supabase.rpc('enqueue_email', {
          ...
          payload: {
            ...
            subject: EMAIL_SUBJECTS[emailType]?.[locale] || EMAIL_SUBJECTS[emailType]?.en || 'Notification',
            html,
            text,
