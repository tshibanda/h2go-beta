...
export const TRANSLATIONS = {
  en: {
    ...
    "val.step1Header": "Step 1 — Before",
    "val.step2Header": "Step 2 — After",
    "val.step1Hint": "Snap your **full** container of water",
    "val.step2Hint": "Snap the **same** container after drinking",
    "val.drinkTitle": "Now take a sip!",
    "val.drinkBody": "Drink some water from the same container, then snap the after photo to log what you actually drank.",
    "val.beforeLabel": "Container before",
    "val.consumedLabel": "You drank",
    "val.diffDetail": "{before} ml → {after} ml",
    "val.tookSip": "I drank — snap after photo",
    "val.reminderTitle": "💧 Finish your sip check",
    "val.reminderBody": "Take the second photo to log what you just drank.",
    "val.reminderInfo": "We'll remind you in 2 minutes if you haven't finished.",
    "val.samePhoto": "Please take a fresh photo, not the same as before.",
  ...
  fr: {
    ...
    "val.step1Header": "Étape 1 — Avant",
    "val.step2Header": "Étape 2 — Après",
    "val.step1Hint": "Photographie ton contenant **plein** d'eau",
    "val.step2Hint": "Photographie le **même** contenant après avoir bu",
    "val.drinkTitle": "Bois une gorgée !",
    "val.drinkBody": "Bois de l'eau du même contenant, puis prends la photo « après » pour enregistrer la quantité réellement bue.",
    "val.beforeLabel": "Contenant avant",
    "val.consumedLabel": "Tu as bu",
    "val.diffDetail": "{before} ml → {after} ml",
    "val.tookSip": "J'ai bu — photo après",
    "val.reminderTitle": "💧 Termine ta validation",
    "val.reminderBody": "Prends la deuxième photo pour enregistrer ta gorgée.",
    "val.reminderInfo": "On te rappellera dans 2 minutes si ce n'est pas fait.",
    "val.samePhoto": "Prends une nouvelle photo, différente de la précédente.",
