...
export const TRANSLATIONS = {
  en: {
    ...
    "intro.s2.title": "2. Snap BEFORE & AFTER",
    "intro.s2.body": "Take a live photo of your full container BEFORE drinking, then a second photo AFTER — we ping you in 2 min if you forget.",
    "intro.s3.title": "3. AI measures your real sip",
    "intro.s3.body":
      "Our vision AI compares both photos to calculate exactly how much you drank, rewards you with XP, and grows your streak.",
    ...
    "home.editGoalTitle": "Adjust your daily goal",
    "home.editGoalDesc": "Set your hydration target between 500 ml and 6000 ml.",
    "home.save": "Save",
    "home.cancel": "Cancel",
    "rate.title": "Enjoying H2GO?",
    "rate.body": "You've been staying hydrated with us for a few days now 💧 Would you take a moment to rate the app on the App Store? It really helps us grow!",
    "rate.cta": "Rate H2GO",
    "rate.later": "Maybe later",
    "rate.never": "No thanks",
    ...
    "val.frameHintBefore": "Show your **full** container of water **before** drinking",
    "val.frameHintAfter": "Show the **same** container **after** you drank",
    "val.cameraDenied": "Camera access denied. Please allow camera to validate hydration.",
    "val.tapToCapture": "Tap to capture",
    "val.tapBefore": "Tap to capture the BEFORE photo",
    "val.tapAfter": "Tap to capture the AFTER photo",
    "val.step1Header": "📸 Before you drink",
    "val.step2Header": "🥤 After you drank",
    "val.stepIndicator": "Step {n} / 2",
    "val.analyzing": "AI is checking your sip…",
    "val.approved": "Nice sip!",
    "val.approvedBody": "+{ml} ml logged 💧",
    "val.adjustHint": "Adjust the amount of water you actually drank",
    "val.adjustLabel": "Volume",
    "val.saveContinue": "Save & continue",
    "val.continue": "Continue",
    "val.rejected": "Hmm, not water",
    "val.later": "Later",
    "val.retry": "Try again",
    "val.retryPhoto": "Retry photo",
    "val.failed": "Validation failed",
    "val.waitDrinkTitle": "Now take your sip 💧",
    "val.waitDrinkBody": "Drink your water, then come back to snap the after-photo so we can calculate exactly what you drank.",
    "val.beforeDetected": "Detected: ~{ml} ml in your container",
    "val.reminderNote": "We'll remind you in 2 minutes if you haven't finished.",
    "val.takeSecondPhoto": "I've drunk — take the 2nd photo",
    "val.afterFailed": "We couldn't compare the two photos. Try the after-photo again.",
    "val.afterAttempt": "Attempt {n} of 2",
    "val.manualTitle": "Enter the amount manually",
    "val.manualHint": "We couldn't validate your after-photo. Enter how much you actually drank.",
    "val.manualSubmit": "Log this sip",
    "val.reminderTitle": "Don't forget your 2nd photo 💧",
    "val.reminderBody": "Snap the after-photo to validate your sip.",


    // Achievements
    "ach.streak_7.title": "7-day streak",
    "ach.streak_7.desc": "Drink water 7 days in a row",
    "ach.streak_30.title": "30-day streak",
    "ach.streak_30.desc": "One month of hydration",
    "ach.streak_90.title": "90-day streak",
    "ach.streak_90.desc": "Three months strong",
    "ach.streak_365.title": "365-day streak",
    "ach.streak_365.desc": "A full year hydrated",
    "ach.validations_100.title": "100 validations",
    "ach.validations_100.desc": "100 verified drinks",
    "ach.validations_1000.title": "1000 validations",
    "ach.validations_1000.desc": "1000 verified drinks",
    "ach.volume_10000.title": "10L consumed",
    "ach.volume_10000.desc": "10 liters total",
    "ach.volume_100000.title": "100L consumed",
    "ach.volume_100000.desc": "100 liters total",
  ...
  fr: {
    ...
    "intro.s2.title": "2. Photo AVANT & APRÈS",
    "intro.s2.body": "Prends une photo de ton contenant plein AVANT de boire, puis une seconde APRÈS — on te rappelle dans 2 min si tu oublies.",
    "intro.s3.title": "3. L'IA mesure ta vraie gorgée",
    "intro.s3.body":
      "Notre IA vision compare les deux photos pour calculer exactement la quantité bue, te récompense en XP et fait grandir ta série.",
    ...
    "home.encouragement": "N'oublie pas de valider ta gorgée 💦",
    ...
    "home.editGoalTitle": "Ajuste ton objectif quotidien",
    "home.editGoalDesc": "Choisis ta cible d'hydratation entre 500 ml et 6000 ml.",
    "home.save": "Enregistrer",
    "home.cancel": "Annuler",
    "rate.title": "Tu aimes H2GO ?",
    "rate.body": "Cela fait déjà quelques jours que tu t'hydrates avec nous 💧 Prendrais-tu un instant pour noter l'app sur l'App Store ? Ça nous aide énormément !",
    "rate.cta": "Noter H2GO",
    "rate.later": "Plus tard",
    "rate.never": "Non merci",
    ...
    "val.frameHintBefore": "Montre ton contenant **plein** d'eau **avant** de boire",
    "val.frameHintAfter": "Montre le **même** contenant **après** avoir bu",
    ...
    "val.tapBefore": "Touche pour prendre la photo AVANT",
    "val.tapAfter": "Touche pour prendre la photo APRÈS",
    "val.step1Header": "📸 Avant de boire",
    "val.step2Header": "🥤 Après avoir bu",
    "val.stepIndicator": "Étape {n} / 2",
    "val.analyzing": "L'IA vérifie ta gorgée…",
    "val.approved": "Bien joué !",
    "val.approvedBody": "+{ml} ml enregistrés 💧",
    "val.adjustHint": "Ajuste la quantité d'eau réellement bue",
    "val.adjustLabel": "Volume",
    "val.saveContinue": "Enregistrer & continuer",
    "val.continue": "Continuer",
    "val.rejected": "Hmm, pas de l'eau",
    "val.later": "Plus tard",
    "val.retry": "Réessayer",
    "val.retryPhoto": "Reprendre la photo",
    "val.failed": "Échec de la validation",
    "val.waitDrinkTitle": "À toi de boire 💧",
    "val.waitDrinkBody": "Bois ton eau, puis reviens prendre la photo APRÈS pour qu'on calcule exactement ce que tu as bu.",
    "val.beforeDetected": "Détecté : ~{ml} ml dans ton contenant",
    "val.reminderNote": "On t'enverra un rappel dans 2 minutes si tu n'as pas terminé.",
    "val.takeSecondPhoto": "J'ai bu — prendre la 2e photo",
    "val.afterFailed": "Impossible de comparer les deux photos. Réessaie la photo APRÈS.",
    "val.afterAttempt": "Essai {n} sur 2",
    "val.manualTitle": "Saisis la quantité manuellement",
    "val.manualHint": "On n'a pas pu valider ta photo APRÈS. Indique la quantité réellement bue.",
    "val.manualSubmit": "Enregistrer cette gorgée",
    "val.reminderTitle": "N'oublie pas ta 2e photo 💧",
    "val.reminderBody": "Prends la photo APRÈS pour valider ta gorgée.",


    // Succès / badges
    "ach.streak_7.title": "Série de 7 jours",
    "ach.streak_7.desc": "Bois de l'eau 7 jours d'affilée",
    "ach.streak_30.title": "Série de 30 jours",
    "ach.streak_30.desc": "Un mois d'hydratation",
    "ach.streak_90.title": "Série de 90 jours",
    "ach.streak_90.desc": "Trois mois au top",
    "ach.streak_365.title": "Série de 365 jours",
    "ach.streak_365.desc": "Une année entière hydraté",
    "ach.validations_100.title": "100 validations",
    "ach.validations_100.desc": "100 gorgées vérifiées",
    "ach.validations_1000.title": "1000 validations",
    "ach.validations_1000.desc": "1000 gorgées vérifiées",
    "ach.volume_10000.title": "10 L bus",
    "ach.volume_10000.desc": "10 litres au total",
    "ach.volume_100000.title": "100 L bus",
    "ach.volume_100000.desc": "100 litres au total",
